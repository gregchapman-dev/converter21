...
#         chord.run(outfile) # makes sure each note in the chord has the right stuff on it?
    ...
    ) -> list[tuple[str, m21.prebase.ProtoM21Object]]:
    ...
    def _emitContributorNameList(
        ...
        skipName: m21.metadata.Text | None = None
    ) -> None:
        ...
        k: str | None = M21Convert.m21ContributorRoleToHumdrumReferenceKey.get(c.role, None)
        if k is None:
...
#        print('metadata = \n', m21Metadata.all(), file=sys.stderr)
        ...
        # pylint: disable=protected-access
        firstComposerNameEmitted: m21.metadata.Text | None = None
        titleEmitted: bool = False
        movementNameEmitted: bool = False
        copyrightEmitted: bool = False

        atLine: int = 0
        composers: tuple[m21.metadata.Contributor, ...] = (
