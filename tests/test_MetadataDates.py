...
def test_DateSingle():
    ...
    dateSingle = M21Utilities.m21DateObjectFromString(string)
...
def test_DateRelative():
    ...
    string = '>1979z/06x/01z/17x:03z:59.999x'
    dateRelative = M21Utilities.m21DateObjectFromString(string)
...
def test_DateBetween():
    ...
    dateBetween = M21Utilities.m21DateObjectFromString(string)
...
def test_DateSelection():
    ...
    dateSelection = M21Utilities.m21DateObjectFromString(string)
