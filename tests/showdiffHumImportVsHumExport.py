...
#     score2.show('musicxml.pdf')
    ...
    score_lin1 = AnnScore(score1, DetailLevel.AllObjectsWithStyle | DetailLevel.Metadata)
    print('loaded first score')
    score_lin2 = AnnScore(score2, DetailLevel.AllObjectsWithStyle | DetailLevel.Metadata)
